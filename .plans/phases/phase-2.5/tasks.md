...
7. **Implement tree navigation on `Session`:** [Completed 2026-05-03]
...
8. **Implement context building (`fit_path`):** [Completed 2026-05-03]
...
9. **Define `CompactionStrategy`, `CompactionSummary`, and `MechanicalCompactionStrategy`:** [Completed 2026-05-03]
...
10. **Define the `ExtensionEntry` trait:** [Completed 2026-05-03]
...
11. **Implement JSONL persistence:** [Completed 2026-05-03]
...
12. **Wire the agent loop:** [Completed 2026-05-03]
...
14. **Update the binary:** [Completed 2026-05-03]
...
15. **Migrate existing tests:** [Completed 2026-05-03]
...
16. **Add Phase 2.5–specific tests:** [Partially completed]
    ...
    - ✅ **Tree integrity:** appending entries always produces a valid tree.
    - ✅ **Path building:** `path_to_root()` returns entries in correct order with no duplicates and no orphans.
    - ✅ **Resolution filtering:** `fit_path` skips `Compacted` and `Attached` entries.
    - ✅ **Branching:** `branch_to`, `branch_with_summary`, old branch preserved in tree.
    - ✅ **Compaction:** `MechanicalCompactionStrategy`, `compact_older_than`, resolution transitions.
